...
export const RPC_WITHOUT_ADVANCED_MODE = "Use --advanced to connect to a bitumd instance manually via PRC";
export const RPCCONNECT_INVALID_FORMAT = "Please provide a valid host and port for --rpcconnect, eg. --rpcconnect=\"127.0.0.1:19209\"";
...
Options
  ...
  --extrawalletargs  Pass extra arguments to bitumwallet.
  --custombinpath    Custom path for bitumd/bitumwallet/bitumctl binaries.
` : null;

export const DIFF_CONNECTION_ERROR = "daemon and bitum does not have the same network";
