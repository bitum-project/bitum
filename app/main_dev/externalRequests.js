...
export const EXTERNALREQUEST_BITUMDATA = "EXTERNALREQUEST_BITUMDATA";
...
export const allowExternalRequest = (externalReqType) => {
  ...
  case EXTERNALREQUEST_STAKEPOOL_LISTING:
    addAllowedURL(/^https:\/\/api\.bitum\.org\/\?c=gsd$/);
    break;
  ...
  case EXTERNALREQUEST_POLITEIA:
    ...
    break;
  case EXTERNALREQUEST_BITUMDATA:
    addAllowedURL(BITUMDATA_URL_TESTNET);
    addAllowedURL(BITUMDATA_URL_MAINNET);
    break;
