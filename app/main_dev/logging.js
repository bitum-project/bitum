...
let bitumdLogs = Buffer.from("");
let bitumwalletLogs = Buffer.from("");
...
// format compatible to bitumd/bitumwallet logs. This function is meant to be
...
// with the bitumd/bitumwallet logs.
...
// bitum app data dir and sends to the console when debug == true.
  ...
  logger = new (winston.Logger)({
    transports: [
      new (winston.transports.File)({
        json: false,
        filename: path.join(appDataDirectory(), "bitum.log"),
...
export const AddToBitumdLog = (destIO, data, debug) => {
  bitumdLogs = AddToLog(destIO, bitumdLogs, data, debug);
};

export const AddToBitumwalletLog = (destIO, data, debug) => {
  bitumwalletLogs = AddToLog(destIO, bitumwalletLogs, data, debug);
};

export const GetBitumdLogs = () => bitumdLogs;

export const GetBitumwalletLogs = () => bitumwalletLogs;
...
export function ClearBitumwalletLogs() {
  bitumwalletLogs = Buffer.from("");
}
