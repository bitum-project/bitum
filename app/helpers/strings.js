...
// restrictToStdDecimalNumber) into a bitum atom amount. This performs a
...
//
// Due to floating point inacuracies, a rounding function compatible to bitumutil
// `round` is used (see:
// https://github.com/bitum-project/bitumd/blob/v1.1.2/bitumutil/amount.go#L77)
//
...
//
// This is fine for representing numbers within the range of the total bitum
// supply (up to 21e14) but may not be arbitrarily applicable.
export function strToBitumAtoms(s, unitDivisor) {
