...
class EyeFilterMenuWithSlider extends React.Component {
  ...
  componentDidMount() {
    ...
    if(maxFilterValue) {
      const maxValue = currencyDisplay === "BITUM" ? maxFilterValue/unitDivisor : maxFilterValue;
    ...
    if(minFilterValue) {
      const minValue = currencyDisplay === "BITUM" ? minFilterValue/unitDivisor : minFilterValue;
