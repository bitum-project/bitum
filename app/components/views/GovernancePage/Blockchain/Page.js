  ...
  <>
    <div className="consensus-changes-header">
      ...
      <p className="proposals-community-header-description">
        <T id="votingPreferences.description" m="Consensus changes refer to the on-chain governance aspect of Bitum. This means deciding whether to adopt changes to the consensus rules of the network. Participation in voting requires (PoS) tickets." />
      </p>
      <div className="links">
        <ExternalLink className="info-modal-button" href="https://docs.bitum.io/getting-started/user-guides/agenda-voting/"/>
        <ExternalLink href="https://voting.bitum.io"><T id="votingPreferences.dashboard" m="Voting Dashboard" /></ExternalLink>
      </div>
    </div>
