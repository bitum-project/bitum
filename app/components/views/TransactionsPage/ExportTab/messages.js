...
export default {
  ...
  dailyBalances: {
    ...
    fields: [
      ...
      { name: "totalStake", description: <T id="export.balances.fields.totalStake" m="Total amount of BITUM used on staking." /> },
      ...
      { name: "voted", description: <T id="export.dailyBalances.fields.voted" m="Total amount, in BITUM, of tickets voted" /> },
      { name: "revoked", description: <T id="export.dailyBalances.fields.revoked" m="Total amount, in BITUM, of tickets revoked" /> },
      { name: "ticket", description: <T id="export.dailyBalances.fields.ticket" m="Total amount, in BITUM, spent in tickets" /> },
    ]
  },
  balances: {
