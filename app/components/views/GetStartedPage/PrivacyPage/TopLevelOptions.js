...
export default ({ setupStandardPrivacy, setupDisabledPrivacy, setupCustomPrivacy }) => (
  <>
    ...
    <div className="language-select-title-sub">
      <T id="privacy.titleSub" m={"Select how Bitum should connect to external services. You can change this in the application settings later."}/>
    </div>
    <div className="privacy-options">
      ...
      <PrivacyOption
        ...
        icon="disabled"
        description={<T id="privacy.options.disabled.description" m="Disables all connections to third party (non-bitumd/non-bitumwallet) services. This may prevent you from using certain features of the app. Recommended for advanced users." />}
