...
export const LoaderTitleMsg = () => <T id="loader.title" m={"Welcome to Bitum Wallet"}/>;
export const DiscoverAccountsInfoMsg = () =>
  ...
  Your account names aren't stored on the blockchain, so you will have to rename them after setting up Bitum.
  `}/>;
...
export const UpdateAvailableLink = ({ updateAvailable }) => (
  <Tooltip text={<T id="getStarted.updateAvailableTooltip" m="New version {version} available" values={{ version: (updateAvailable) }}/>}>
    <ExternalLink className="update-available-button" href="https://bitum.io/downloads">
...
export const AboutModalButton = ({ appVersion, updateAvailable }) => (
  <AboutModalButtonInvisible
    ...
    buttonLabel={<T id="help.about" m="About Bitum" />}
  />
);
