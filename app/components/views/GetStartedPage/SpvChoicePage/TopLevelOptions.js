...
export default ({ enableSpv, disableSpv }) => (
  <Aux>
    ...
    <div className="language-select-title-sub">
      <T id="spv.titleSub" m={"Select how Bitum wallet's should connect to the network. You can change this in the application settings later. For more in-depth information about SPV and how it works, you can go "}/>
      <ExternalLink href={"https://docs.bitum.io/wallets/spv/"}><T id="spv.titleSub.here" m="here"/></ExternalLink>.
    </div>
    <div className="privacy-options">
      ...
      <PrivacyOption
        ...
        icon="disable-spv"
        description={<T id="spv.options.disable.description" m="This will use the regular Bitum Daemon and fully verify blocks.  This will take longer, but is fully secure.  Any block or mined transaction can be fully trusted." />}
        onClick={disableSpv}
      />
