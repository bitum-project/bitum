...
const AccountsListHeader = ({ onGetNextAccountAttempt, isCreateAccountDisabled }) => <StandaloneHeader
  ...
  description={<T id="accounts.description" m={"Accounts allow you to keep separate records of your BITUM funds.\nTransferring BITUM across accounts will create a transaction on the blockchain."}/>}
