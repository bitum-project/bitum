  ...
  <StandalonePageBody>
    <div className="invalid-rpc-info">
      <T
        ...
        m={`The API of the currently running wallet ({walletRPCVersion}) is not compatible with Bitum (required version {requiredWalletRPCVersion}).

        Please update the daemon (bitumd) and wallet (bitumwallet) to the latest version, then try again.`}
